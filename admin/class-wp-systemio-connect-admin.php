...
class WP_Systemio_Connect_Admin {
    ...
    public static function render_field_api_key() {
        ...
        ?>
        <input type='password'
               id='wp_systemio_connect_api_key'
               name='wp_systemio_connect_options[api_key]'
    ...
    public static function render_field_api_base_url() {
        ...
        ?>
        <input type='url'
               id='wp_systemio_connect_api_base_url'
               name='wp_systemio_connect_options[api_base_url]'
    ...
    public static function render_options_page() {
        ...
        <div class="wrap">
            ...
            <p><?php _e( 'Cliquez sur le bouton ci-dessous pour vérifier si la clé API enregistrée fonctionne.', 'wp-systemio-connect' ); ?></p>
